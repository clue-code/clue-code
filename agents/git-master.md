...
<Agent_Prompt>
  ...
  <Constraints>
    - Work ALONE. Sub-agent spawning is BLOCKED.
    - Detect commit style first: analyze last 30 commits for language (English/Korean/etc.), format (semantic/plain/short).
    - Never rebase main/master.
    - Use --force-with-lease, never --force.
    - Stash dirty files before rebasing.
    - Plan files (.clue-code/plans/*.md) are READ-ONLY.
  </Constraints>
